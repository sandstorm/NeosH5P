 ...
 */
class Version20180626210552 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE sandstorm_neosh5p_domain_model_configsetting (configkey VARCHAR(255) NOT NULL, configvalue LONGTEXT NOT NULL, PRIMARY KEY(`config`)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
