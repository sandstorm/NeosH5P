 ...
 */
class Version20180702054137 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE sandstorm_neosh5p_domain_model_content (persistence_object_identifier VARCHAR(40) NOT NULL, library VARCHAR(40) DEFAULT NULL, account VARCHAR(40) DEFAULT NULL, createdat DATETIME NOT NULL, updatedat DATETIME NOT NULL, title VARCHAR(255) NOT NULL, parameters LONGTEXT NOT NULL, filtered LONGTEXT NOT NULL, slug VARCHAR(255) NOT NULL, embedtype VARCHAR(255) NOT NULL, disable INT NOT NULL, contenttype VARCHAR(255) DEFAULT NULL, author VARCHAR(255) DEFAULT NULL, license VARCHAR(255) DEFAULT NULL, keywords LONGTEXT DEFAULT NULL, description LONGTEXT DEFAULT NULL, INDEX IDX_1727B66FA18098BC (library), UNIQUE INDEX UNIQ_1727B66F7D3656A4 (account), PRIMARY KEY(persistence_object_identifier)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
