 ...
 */
class Version20180628052331 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE sandstorm_neosh5p_domain_model_configsetting (configkey VARCHAR(255) NOT NULL, configvalue LONGTEXT NOT NULL, PRIMARY KEY(configkey)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
